...
int runCar(int n, char commandList[n]){
//int main(){
    HANDLE hSerial;
    ...
    initSio(hSerial);
    //char commandList[] = {0x84, 0x84, 0x81, 0x84,0x81, 0x84, 0x81, 0x84, 0x81};
    ...
    while ( 1 ) {
        ...
        *byteBuffer = c;
        ...
        char byteBufferr = commandList[k];
